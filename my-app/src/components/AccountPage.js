...
const AccountPage = () => {
  ...
  useEffect(() => {
    ...
    if (!email) {
      ...
      navigate('/investor-profile'); // Redirect if user is an investor
    }
  }, [navigate]);
  
  const categories = ['UI/UX', 'Web Devlopment', 'App Devlopment', 'AI/ML' ];
  ...
  <div className="form-container">
    ...
    {showForm && (
      <div className="form-wrapper">
        <h2 className="form-title">Add a new startup idea</h2>
